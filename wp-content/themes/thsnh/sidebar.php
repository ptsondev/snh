...
<div class="block" id="in-catalogue-re-dep-nhanh"><a href="http://snh.vn/dich-vu/in-catalogue-re-dep-nhanh/"><img src="http://snh.vn/wp-content/themes/thsnh/images/dich-vu-in-catalogue-re-dep-nhanh.jpg" /></a></div>
...
<div class="block" id="sticky-article">
	...
	if ($wp_query->have_posts()) {            
		while ($wp_query->have_posts()) : $wp_query->the_post();
			...
			echo '<li>';
				//echo '<div class="col-sm-5 col-xs-12"><a href="'.get_permalink(get_the_ID()).'"><img src="'.$thumb.'" alt="'.get_the_title().'"/></a></div>';
	...
	?>
	<div class="btn-all-articles"><i class="fa fa-info-circle"></i> <a href="http://snh.vn/kien-thuc/"> Xem tất cả những bài viết về kiến thức thiết kế quảng cáo </a> <i class="fa fa-info-circle"></i></div>
</div>


<div class="block" id="support-online">
	<h2 class="block-title">Tư vấn nhanh</h2>	
...
<b>Làm thế nào để trở thành 1 người sếp tốt?<br />
 Làm thế nào để công ty phát triển vững mạnh hơn? </b><br />
